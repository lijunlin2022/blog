...
- [JavaScript](./js/README.md)
  ...
  - [转换数值和转换字符串](./js/to-number-and-to-string.md)
  - [逻辑与和逻辑或](./js/and-or.md)
...
- [北理工](./bit-life/README.md)
  ...
  - [Windows 下 32 位汇编贪吃蛇](./bit-life/snake/README.md)
    - [printf 和 scanf](./bit-life/snake/printf-and-scanf.md)
    - [cmp 和 jmp](./bit-life/snake/cmp-and-jmp.md)
    - [ExitProcess](./bit-life/snake/exit-process.md)
    - [loop](./bit-life/snake/loop.md)
    - [idiv](./bit-life/snake/idiv.md)
    - [移动和生长](./bit-life/snake/movement-and-growth.md)
